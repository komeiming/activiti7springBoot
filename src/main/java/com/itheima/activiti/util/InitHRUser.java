    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        try {
            ...
            if (hrUserCount == 0) {
                ...
                jdbcTemplate.update(
                    "INSERT INTO sys_user (id, username, password, full_name, email, phone, department, position, status) " +
                    "VALUES (2, 'hr', '$2a$10$JjP1FbYVb3V8qkZ7vJZ6JOMQK5Y6q1K7h5k5Z5m5n5l5j5H5G5F5E', 'HR专员', 'hr@example.com', '13800138001', '人力资源部', 'HR专员', 1)");
            } else {
            ...
            Integer userRoleCount = jdbcTemplate.queryForObject(
                "SELECT COUNT(*) FROM sys_user_role WHERE user_id = 2 AND role_id = 3", Integer.class);
